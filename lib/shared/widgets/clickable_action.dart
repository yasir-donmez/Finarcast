...
class ClickableAction extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ClickableAction> createState() => _PrecisionActionState();
}

class _PrecisionActionState extends State<ClickableAction> {
